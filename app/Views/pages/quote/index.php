...
<style>
    ...
    .quote-pick__note {
        ...
        margin: 0; color: var(--ink-3); font-size: var(--fs-300); max-width: 60ch;
    }
    ...
    .quote-pick__search {
        ...
        border-radius: var(--radius-pill); background: var(--bg-1);
        color: var(--ink-1); font: inherit; font-size: var(--fs-300);
        transition: border-color var(--dur-base) var(--ease-out), box-shadow var(--dur-base) var(--ease-out);
    }
    .quote-pick__search:focus { outline: none; border-color: var(--blue-bright); box-shadow: 0 0 0 4px var(--blue-soft); }
    ...
    .quote-item {
        ...
        background: var(--bg-1); color: var(--ink-1); text-decoration: none;
        transition: border-color var(--dur-base) var(--ease-out),
                    transform var(--dur-base) var(--ease-out),
                    box-shadow var(--dur-base) var(--ease-out);
    }
    .quote-item:hover {
        border-color: var(--blue-bright); transform: translateY(-3px); box-shadow: var(--lift-md);
    }
    .quote-item__name { font-weight: var(--fw-medium); line-height: var(--lh-snug); }
    .quote-item__cta {
        flex: none; display: inline-flex; align-items: center; gap: 6px;
        color: var(--blue-bright); font-size: var(--fs-300); font-weight: var(--fw-semibold); white-space: nowrap;
    }
    .quote-item__cta svg { width: 16px; height: 16px; }

    .quote-pick__empty { color: var(--ink-3); text-align: center; padding: var(--space-6) 0; }
    .quote-pick__alt { margin-top: var(--space-7); color: var(--ink-3); font-size: var(--fs-300); }
    .quote-pick__alt a { color: var(--blue-bright); }
...
<section class="quote-pick">
    <div class="container">
        ...
        <div class="quote-pick__bar" data-reveal>
        ...
        <?php foreach ($categories as $category): ?>
            <div class="quote-cat" data-quote-cat data-reveal>
