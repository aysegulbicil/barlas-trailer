...
?>
<form method="post" action="<?= $isEdit ? qr_url('admin/shifts/' . $shift['id']) : qr_url('admin/shifts') ?>">
    <?= csrf_field() ?>
    ...
    <div class="form-actions"><button class="btn btn-primary">Kaydet</button><a class="btn btn-link" href="<?= qr_url('admin/shifts') ?>">İptal</a></div>
</form>
