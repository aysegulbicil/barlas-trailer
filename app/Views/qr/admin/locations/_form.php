...
?>
<form method="post" action="<?= $isEdit ? qr_url('admin/locations/' . $location['id']) : qr_url('admin/locations') ?>">
    <?= csrf_field() ?>
    <div class="grid2">
    ...
    <div class="form-actions"><button class="btn btn-primary">Kaydet</button><a class="btn btn-link" href="<?= qr_url('admin/locations') ?>">İptal</a></div>
</form>
<script>
(function () {
