...
?>
<form method="post" action="<?= $isEdit ? qr_url('admin/attendance/' . $log['id']) : qr_url('admin/attendance') ?>">
    <?= csrf_field() ?>
    ...
    <div class="form-actions"><button class="btn btn-primary">Kaydet</button><a class="btn btn-link" href="<?= qr_url('admin/attendance') ?>">İptal</a></div>
</form>
