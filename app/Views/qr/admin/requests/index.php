                ...
                <tr>
                    ...
                    <td class="row-actions">
                        <?php if ($l['status'] === 'pending'): ?>
                            <form method="post" action="<?= qr_url('admin/requests/leave/' . $l['id'] . '/approve') ?>"><?= csrf_field() ?><button class="btn btn-primary btn-sm">Onayla</button></form>
                            <form method="post" action="<?= qr_url('admin/requests/leave/' . $l['id'] . '/reject') ?>"><?= csrf_field() ?><button class="btn btn-danger-soft btn-sm">Reddet</button></form>
                        <?php else: ?>
                ...
                <tr>
                    ...
                    <td class="row-actions">
                        <?php if ($a['status'] === 'pending'): ?>
                            <form method="post" action="<?= qr_url('admin/requests/advance/' . $a['id'] . '/approve') ?>"><?= csrf_field() ?><button class="btn btn-primary btn-sm">Onayla</button></form>
                            <form method="post" action="<?= qr_url('admin/requests/advance/' . $a['id'] . '/reject') ?>"><?= csrf_field() ?><button class="btn btn-danger-soft btn-sm">Reddet</button></form>
                        <?php else: ?>
