...
?>
<form method="post" action="<?= $isEdit ? qr_url('admin/tasks/' . $task['id']) : qr_url('admin/tasks') ?>">
    <?= csrf_field() ?>
    ...
    <?php endif; ?>
    <div class="form-actions"><button class="btn btn-primary">Kaydet</button><a class="btn btn-link" href="<?= qr_url('admin/tasks') ?>">İptal</a></div>
</form>
<?php if (! $isEdit): ?>
<script>
(function () {
