...
<form method="post" action="<?= $isEdit ? qr_url('admin/departments/' . $department['id']) : qr_url('admin/departments') ?>">
    <?= csrf_field() ?>
    ...
    <div class="form-actions">
        ...
        <a class="btn btn-link" href="<?= qr_url('admin/departments') ?>">İptal</a>
    </div>
</form>
