...
<div class="card-head">
    <h1>Raporlar</h1>
    <div class="btn-group">
        <a class="btn btn-outline btn-sm" href="<?= qr_url('admin/reports/export') . '?' . $qs ?>">Excel (CSV)</a>
        <a class="btn btn-outline btn-sm" href="<?= qr_url('admin/reports/print') . '?' . $qs ?>" target="_blank" rel="noopener">Yazdır / PDF</a>
    </div>
</div>

<form method="get" action="<?= qr_url('admin/reports') ?>" class="filters">
