...
<div class="card-head">
    ...
    <a class="btn btn-primary" href="<?= qr_url('admin/employees/new') ?>" data-modal data-modal-title="Yeni personel" data-modal-size="lg">+ Yeni personel</a>
</div>

<form method="post" action="<?= qr_url('admin/employees/bulk') ?>" id="empBulk">
    <?= csrf_field() ?>
    <div class="card">
        <?php if (empty($rows)): ?>
            <?= view('qr/partials/empty', [
                'title'       => 'Henüz personel yok',
                'message'     => 'İlk personelini ekleyerek başla.',
                'actionUrl'   => qr_url('admin/employees/new'),
        ...
        <table class="data no-dt" id="empTable" style="width:100%">
            ...
            <?php foreach ($rows as $r): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a class="cell-user" href="<?= qr_url('admin/employees/' . $r['id']) ?>">
                    ...
                    <td class="row-actions">
                        <a href="<?= qr_url('admin/employees/' . $r['id']) ?>">Profil</a>
                        <a class="btn btn-warning-soft btn-sm" href="<?= qr_url('admin/employees/' . $r['id'] . '/edit') ?>" data-modal data-modal-title="Personeli düzenle" data-modal-size="lg">Düzenle</a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
