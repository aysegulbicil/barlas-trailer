...
<div class="card pad-lg">
    <div class="profile-head">
        ...
        <div class="pactions"><a class="btn btn-warning-soft" href="<?= qr_url('admin/employees/' . $emp['id'] . '/edit') ?>" data-modal data-modal-title="Personeli düzenle" data-modal-size="lg">Düzenle</a></div>
    </div>
</div>
